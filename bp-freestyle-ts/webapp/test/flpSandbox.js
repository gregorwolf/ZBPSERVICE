		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#cswbpfreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cswbpfreestyle-display": {
								"semanticObject": "cswbpfreestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=csw.bpfreestyle",
									"url": sap.ui.require.toUrl("csw/bpfreestyle")
								}
							}
						}
					}
