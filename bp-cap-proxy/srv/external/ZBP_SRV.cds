/* checksum : 4300418bf194ebe24553e2a7e4f5e2aa */
@cds.external : true
...
entity ZBP_SRV.BPAddressSet {
  ...
  to_Attachments : Association to many ZBP_SRV.BPAttachmentSet on to_Attachments.Partner = Partner;
};
...
entity ZBP_SRV.CountryVHSet {
  ...
  @sap.sortable : 'false'
  @sap.filterable : 'false'
  CountryDescription : String(15) not null;
};
...
@sap.pageable : 'false'
@sap.content.version : '1'
entity ZBP_SRV.BPAttachmentSet {
  @sap.unicode : 'false'
  @sap.label : 'BusinessPartner'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  ...
  key Partner : String(10) not null;
  @sap.unicode : 'false'
  @sap.label : 'Folder Entry ID (Obj+Fol+Forwarder Name)'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
  @sap.filterable : 'false'
  key DocId : String(46) not null;
  @sap.unicode : 'false'
  @sap.label : 'Mimetype'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
...
@cds.persistence.skip : true
@sap.content.version : '1'
entity ZBP_SRV.SAP__Currencies {
  @sap.label : 'Currency'
...
@cds.persistence.skip : true
@sap.content.version : '1'
entity ZBP_SRV.SAP__UnitsOfMeasure {
...
@cds.persistence.skip : true
@sap.content.version : '1'
entity ZBP_SRV.SAP__MyDocumentDescriptions {
  @sap.label : 'UUID'
  ...
  @cds.ambiguous : 'missing on condition?'
  Format : Association to ZBP_SRV.SAP__FormatSet on Format.Id = Id;
  @cds.ambiguous : 'missing on condition?'
  TableColumns : Association to many ZBP_SRV.SAP__TableColumnsSet on TableColumns.Id = Id;
  @cds.ambiguous : 'missing on condition?'
  CoverPage : Association to many ZBP_SRV.SAP__CoverPageSet on CoverPage.Id = Id;
  @cds.ambiguous : 'missing on condition?'
  Signature : Association to ZBP_SRV.SAP__SignatureSet on Signature.Id = Id;
  @cds.ambiguous : 'missing on condition?'
  PDFStandard : Association to ZBP_SRV.SAP__PDFStandardSet on PDFStandard.Id = Id;
};
...
entity ZBP_SRV.SAP__FormatSet {
  ...
  @sap.filterable : 'false'
  key Id : UUID not null;
  FitToPage : ZBP_SRV.SAP__FitToPage not null;
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
  @sap.filterable : 'false'
...
@sap.addressable : 'false'
@sap.content.version : '1'
entity ZBP_SRV.SAP__PDFStandardSet {
  @sap.label : 'UUID'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
...
@sap.addressable : 'false'
@sap.content.version : '1'
entity ZBP_SRV.SAP__TableColumnsSet {
  @sap.label : 'UUID'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
...
@sap.addressable : 'false'
@sap.content.version : '1'
entity ZBP_SRV.SAP__CoverPageSet {
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
  @sap.filterable : 'false'
...
@sap.addressable : 'false'
@sap.content.version : '1'
entity ZBP_SRV.SAP__SignatureSet {
  @sap.label : 'UUID'
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  @sap.sortable : 'false'
...
@cds.persistence.skip : true
@sap.content.version : '1'
entity ZBP_SRV.SAP__ValueHelpSet {
