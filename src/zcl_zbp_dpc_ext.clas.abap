...
*            WITH SY-MSGV1 SY-MSGV2 SY-MSGV3 SY-MSGV4.
  ...
  METHOD /iwbep/if_mgw_appl_srv_runtime~get_stream.
    DATA:
      ...
      , extension TYPE string
      , content_behaviour TYPE string VALUE 'inline'
      , input_length TYPE i
...
*   WITH SY-MSGV1 SY-MSGV2 SY-MSGV3 SY-MSGV4.
      ...
      IF document_data IS NOT INITIAL.
        ...
        CONCATENATE content_behaviour '; filename="' document_data-obj_descr extension '"' INTO ls_header-value.
...
*         WITH SY-MSGV1 SY-MSGV2 SY-MSGV3 SY-MSGV4.
  ...
  METHOD /iwbep/if_mgw_appl_srv_runtime~execute_action.
    IF iv_action_name = 'GetBP'.
      DATA: partner TYPE bu_partner.

      READ TABLE it_parameter ASSIGNING FIELD-SYMBOL(<fs_key>) WITH KEY name = 'Partner'.
      CALL FUNCTION 'CONVERSION_EXIT_ALPHA_INPUT'
        EXPORTING
          input  = <fs_key>-value
        IMPORTING
